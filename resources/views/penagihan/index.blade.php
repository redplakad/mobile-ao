    ...
    <section id="Store-list" class="flex flex-col gap-6 px-4 mt-[30px]">
            ...
            <a href="{{ route('penagihan.detail', $data->uuid) }}" class="card">
                <div
                    ...
                    <div class="w-full h-[180px] relative overflow-hidden">
                        ...
                        <p
                            class="absolute top-4 right-4 rounded-md px-2 py-1 text-white text-xs font-semibold shadow-sm
                    ...
                    <p class="text-xs text-gray-500 px-4">
                        {{ $data->user->name ?? 'User tidak ditemukan' }} •
        ...
        @empty
            <div
                ...
                <p class="text-sm text-gray-500 max-w-sm">Data penagihan belum tersedia saat ini. Silakan tambahkan data
                    terlebih dahulu atau periksa kembali nanti.</p>
            </div>
        @endforelse
