...
@section('content')
    ...
    <div class="flex h-full flex-1 mt-5">
        <div class="flex flex-col item-center gap-2">
          <a href="{{ route('penagihan.create') }}" class="rounded-full flex ring-1 ring-[#E9E8ED] p-[12px_16px]  bg-[#FF8E62] text-white w-full transition-all duration-300 focus-within:ring-2 focus-within:ring-[#FF8E62] justify-center font-bold">
