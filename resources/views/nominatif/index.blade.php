                ...
                <div class="flex justify-between items-center text-sm text-gray-600 mt-1">
                    ...
                    <div class="flex items-center gap-2">
                        <div class="flex -space-x-2">
                            @foreach ($cabangAvatars as $avatar)
                                <img src="{{ $avatar }}"
                        ...
                        <div class="flex items-center gap-1 text-gray-500">
                            ...
                            <span class="text-xs">{{ $cabangTotalHit }} kali</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm flex flex-col space-y-2">
                <div class="flex items-center space-x-3">
                    ...
                    <div class="flex-1">
                        ...
                        <h3 class="text-sm font-bold mt-1">
                            <span class="font-normal text-gray-500">Rekap kredit per kolektibilitas
                                {{ $selectedCabName }}</span>
                        </h3>
                    </div>
                </div>
                ...
                <div class="flex justify-between items-center text-sm text-gray-600 mt-1">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="flex items-center gap-1 text-gray-500">
                            <x-tabler-eye class="w-5 h-5 text-gray-500 text-xs" />
                            <span class="text-xs">{{ $kolTotalHit }} kali</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm flex flex-col space-y-2">
                <div class="flex items-center space-x-3">
                    ...
                    <div class="flex-1">
                        ...
                        <h3 class="text-sm font-bold mt-1">
                            <span class="font-normal text-gray-500">Rekap kredit per produk {{ $selectedCabName }}</span>
                        </h3>
                    </div>
                </div>
                ...
                <div class="flex justify-between items-center text-sm text-gray-600 mt-1">
                    ...
                    <div class="flex items-center gap-2">
                        <div class="flex -space-x-2">
                            @foreach ($produkAvatars as $avatar)
                                <img src="{{ $avatar }}"
                                    class="w-6 h-6 rounded-full border-2 border-white object-cover">
                            @endforeach
                        </div>
                        <div class="flex items-center gap-1 text-gray-500">
                            <x-tabler-eye class="w-5 h-5 text-gray-500 text-xs" />
                            <span class="text-xs">{{ $produkTotalHit }} kali</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm flex flex-col space-y-2">
                <div class="flex items-center space-x-3">
                    ...
                    <div class="flex-1">
                        ...
                        <h3 class="text-sm font-bold mt-1">
                            <span class="font-normal text-gray-500">Rekap kredit per account officer
                                {{ $selectedCabName }}</span>
                        </h3>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm flex flex-col space-y-2">
                <div class="flex items-center space-x-3">
                    ...
                    <div class="flex-1">
                        ...
                        <h3 class="text-sm font-bold mt-1">
                            <span class="font-normal text-gray-500">Rekap kredit per instansi
                                {{ $selectedCabName }}</span>
                        </h3>
                    </div>
                </div>
