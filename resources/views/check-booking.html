  ...
  <main class="bg-[#FAFAFA] max-w-[640px] mx-auto min-h-screen relative flex flex-col has-[#CTA-nav]:pb-[120px] has-[#Bottom-nav]:pb-[120px]">
    <div class="flex flex-col items-center gap-[50px] max-w-[330px] m-auto h-fit w-full py-6">
      <div class="w-[120px] h-[120px] flex shrink-0">
        <img src="assets/images/icons/illustration7.svg" class="w-full h-full object-contain" alt="icon">
      </div>
      ...
      <form action="booking-details-paid.html" class="w-full rounded-2xl p-5 flex flex-col gap-[26px] bg-white">
        <div class="flex flex-col gap-2">
          ...
          <div class="rounded-full flex items-center ring-1 ring-[#E9E8ED] p-[12px_16px] bg-white w-full transition-all duration-300 focus-within:ring-2 focus-within:ring-[#FF8E62]">
            <div class="w-6 h-6 flex shrink-0 mr-[10px]">
              <img src="assets/images/icons/note-favorite-normal.svg" alt="icon">
            </div>
            <input type="text" name="" id="Book-id" class="appearance-none outline-none w-full font-semibold placeholder:font-normal placeholder:text-[#909DBF]" placeholder="Write your booking id" required>
          </div>
        </div>
        <div class="flex flex-col gap-2">
          ...
          <div class="rounded-full flex items-center ring-1 ring-[#E9E8ED] p-[12px_16px] bg-white w-full transition-all duration-300 focus-within:ring-2 focus-within:ring-[#FF8E62]">
            ...
            <input type="tel" name="" id="Name" class="appearance-none outline-none w-full font-semibold placeholder:font-normal placeholder:text-[#909DBF]" placeholder="What is your phone number" required>
          </div>
        </div>
